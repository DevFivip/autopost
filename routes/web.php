...
Route::middleware(['auth', 'splade', 'verified'])->name('admin.')->group(function () {
    ...
    Route::get('admin/events/monthlyschedules', [App\Http\Controllers\Admin\EventController::class, 'monthlyschedules'])->name('events.monthlyschedules');
    Route::post('admin/events/monthlystore', [App\Http\Controllers\Admin\EventController::class, 'monthlystore'])->name('events.monthlystore');
